...
const FILES = [
  ...
  'src/three/flora.js', 'src/three/trackside.js', 'src/three/dressing.js', 'src/three/terrain.js', 'src/three/pits.js', 'src/three/trackGen.js', 'src/three/carFactory.js', 'src/three/scene.js', 'src/three/cameras.js',
